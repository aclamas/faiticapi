...
append('http://cursos.faitic.uvigo.es/tema1314/claroline/announcements/announcements.php')
wget
branch(:BRANCH_DUPLICATED, :SCATTERED){
    xpath('//table[@class="claroTable"]//span[@class="item"]')
    xpath('//table[@class="claroTable"]//div')
}
