...
setvar(:name=>'username', :value=>'%%1%%')
setvar(:name=>'pass', :value=>'%%2%%')
...
append('http://cursos.faitic.uvigo.es/tema1314/module/CLMARK/entry.php')
wget
branch(:BRANCH_DUPLICATED, :SCATTERED){
xpath('//table[@class="claroTable emphaseLine"]//tr[@align="center"]/td[1]')
xpath('//table[@class="claroTable emphaseLine"]//tr[@align="center"]/td[2]')
xpath('//table[@class="claroTable emphaseLine"]//tr[@align="center"]/td[4]')
