...
#append('http://cursos.faitic.uvigo.es/tema1314/claroline/document/document.php')

append('http://cursos.faitic.uvigo.es/tema1314/claroline/document/%%url%%')
wget(:binary=>'true')
#decorate(:head=>'', :tail=>'', :inputFilter=>'0')
