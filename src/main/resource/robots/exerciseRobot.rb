...
append('http://cursos.faitic.uvigo.es/tema1314/claroline/work/work.php')
wget 
branch(:BRANCH_DUPLICATED, :SCATTERED){
    xpath('//table[@class="claroTable"]//td[1]')
    xpath('//table[@class="claroTable"]//td[3]')
    xpath('//table[@class="claroTable"]//td[4]')
    xpath('//table[@class="claroTable"]//td[1]/a/@href')
}